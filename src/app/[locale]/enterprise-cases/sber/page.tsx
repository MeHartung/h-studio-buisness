...
export async function generateMetadata({
  ...
  const metadata = messages.enterpriseCases?.sber?.meta || {
    title: `Sber - Enterprise Case Study | H-Studio`,
    description: "Платформа для корпоративной аналитики данных"
  };
  
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.h-studio-tech.ru';
  const currentUrl = `${baseUrl}/${locale}/enterprise-cases/sber`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ru: `${baseUrl}/ru/enterprise-cases/sber`,
        en: `${baseUrl}/en/enterprise-cases/sber`,
        de: `${baseUrl}/de/enterprise-cases/sber`,
      },
    },
    openGraph: {
      title: "Sber - Enterprise Case Study",
      description: "Платформа для корпоративной аналитики данных",
      url: currentUrl,
      siteName: "H-Studio",
      images: [
        {
          url: `${baseUrl}/images/blog/Sber/cover/cover.webp`,
          width: 1200,
          height: 630,
          alt: "Sber Case Study",
        },
...
export default async function SberCase({
  params
}: Props) {
  const { locale } = await params;
  setRequestLocale(locale);
  
  const t = await getTranslations('enterpriseCases.sber');
  const tc = await getTranslations('enterpriseCases.sber.content');
  ...
  const breadcrumbItems = [
    ...
    { name: t('title'), url: `${baseUrl}/${locale}/enterprise-cases/sber` },
  ];
  ...
  return (
    <div className="min-h-screen bg-bg relative overflow-hidden">
      ...
      <main className="relative z-10">
              ...
              <div className="w-full max-w-5xl">
                <div className="prose prose-invert max-w-none">
                  <div className="relative">
                    <Image
                      src="/images/blog/Sber/cover/cover.webp"
                      alt={t('coverImageAlt')}
                      width={300}
                      height={225}
        ...
        <RelevantServicesSection relevantServiceIds={['5', '6']} />
